...
const int cInt3=0;
const int cMaxInt=2147483647,cMinInt=-2147483647;
...
void main(){
    ...
    printf("_a is",_a);
       	...
       	if(num==0)printf("result:0");
        else if(num==+1){scanf(temp1);printf("result:",temp1+10-10);}
        else if(num==+2){scanf(temp1,temp2);printf("result:",SquareSum(temp1+0,temp2-2+2));}
        else
            {if(num>0){
            temp2=0;
            if(i<num)do{
